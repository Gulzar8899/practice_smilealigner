                ...
                <div class="md-card cardMobile">
                    ...
                    <div class="uk-grid">
                        <div class="uk-width-1-1 uk-flex uk-flex-right" style="margin: 40px -21px;">
                            <a href="http://localhost/smilealigners/treatmentplanner/createNewPlan" class="md-btn buttonStyling accept-btn deposit-btn" style="background-color:#56BB6D !important;">Update
                            </a>
                        </div>
                    </div>
