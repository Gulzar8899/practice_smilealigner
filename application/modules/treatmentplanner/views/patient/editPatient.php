...
<div id="page_content">
  ...
  <label for="uk_dp_1" class="label-p"><b>Approval Date</b></label>
                    ...
                    <a class="md-btn md-btn-primary md-btn-wave-light cancleButton waves-effect waves-button waves-light buttonStyling borderSetting" href="<?= site_url('treatmentplanner/patient/patientListing') ?>">Cancel</a>
    ...
    <div class="uk-modal-dialog">
        <div class="modal-dialog modal-size">
            <div  class="modal-content">
                ...
                <div class="modal-body">
                      <!-- <form method="POST" action="<?= site_url('treatmentplanner/Doctor/addShippingAddress'); ?>"> -->
...
<script type="text/javascript">
            ...
            $("#createShippingAddress").submit(function (event) {
                ...
                $.ajax({
                    url: "<?php echo base_url('treatmentplanner/Patient/addShippingAddress'); ?>", //backend url
                    ...
                    success: function (response) {
                       ...
                       // Get Doctor Default Shipping/Billing Address                        
                        function firstAjax() {
                        return $.ajax({
                                url:"<?php echo base_url();?>/treatmentplanner/doctor/getSpecificDoctorProfile/"+ doctor_id,
                                type: 'POST',
                                data: {"id":doctor_id},
                                dataType: 'json',
                                success: function(response) {
                        ...
                        function secondAjax() {
                            $.ajax({
                                url:"<?php echo base_url();?>/treatmentplanner/doctor/getSpecificDoctorAddress/"+ doctor_id,
                                type: 'POST',
                                data: {"id":doctor_id},
                                dataType: 'json',
                                success: function(response) {
...
<script type="text/javascript">
  $(document).ready(function(){  
    $(document).on('click', '.car_images', function(){ 
     ...
     $.ajax({  
      url: "<?php echo site_url(''); ?>treatmentplanner/patient/deleteImgPatientData", 
      method:"POST",  
      data:{img_id:img_id},  
      dataType:"json",  
...
$(document).ready(function() {
    ...
    $("#secondNext").click(function(){
        ...
        // alert(value);
           ...
           // Get Doctor Default Shipping/Billing Address                        
            function firstAjax() {
            return $.ajax({
                    url:"<?php echo base_url();?>/treatmentplanner/doctor/getSpecificDoctorProfile/"+ value,
                    type: 'POST',
                    data: {"id":value},
                    dataType: 'json',
                    success: function(response) {
            ...
            function secondAjax() {
                $.ajax({
                    url:"<?php echo base_url();?>/treatmentplanner/doctor/getSpecificDoctorAddress/"+ value,
                    type: 'POST',
                    data: {"id":value},
                    dataType: 'json',
                    success: function(response) {
            ...
            if(value){
                 $.ajax({
                    url:"<?php echo base_url();?>/treatmentplanner/doctor/getAllCoutries/"+ value,
                    type: 'POST',
                    data: {"id":value},
                    dataType: 'json',
                    success: function(response) {
    ...
    function getShippingStates(id) {
      ...
      // alert(country_id);
      $.ajax({
            url:"<?php echo base_url();?>/treatmentplanner/doctor/getStates/"+ country_id,
            type: 'POST',
            data: {"id":country_id},
            dataType: 'json',
            success: function(response) {
    ...
    function getShippingCities(id) {
      ...
      // alert(city_id);
      $.ajax({
            url:"<?php echo base_url();?>/treatmentplanner/doctor/getCities/"+ city_id,
            type: 'POST',
            data: {"id":city_id},
            dataType: 'json',
            success: function(response) {
    ...
    $('#crop').click(function(){
        ...
        canvas.toBlob(function(blob){
            ...
            reader.onloadend = function(){
                ...
                $.ajax({
                    url: site_url + "treatmentplanner/doctor/doctorimgCrop",
                    method:'POST',
