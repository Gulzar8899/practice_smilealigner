        ...
        <div class="md-card uk-margin-medium-bottom">
            <div class="md-card-content">
                ...
                <!-- <div class="uk-width-medium-1-5 addPatientButton regularButtonAlignment w-xs-auto">
                    <a class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light buttonStyling" href="<?= site_url('treatmentplanner/patient/addPatient') ?>">Add</a>
                </div> -->
                ...
                <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr style="padding-right: 15px !important;">
                            ...
                            <td>wed, 21 2021</td>
                            <td><?= ($patientData['pt_objective'] != '') ? $patientData['pt_objective'] : '- - -'; ?></td>
