                                    ...
                                    <div class="uk-grid">
                                        ...
                                        <div class="uk-width-medium-1-3">
                                            ...
                                            <div class="uk-button uk-form-select custom-uk-select" data-uk-form-select>
                                                ...
                                                <select name="billing_country" id="billing_country" onChange="getBillingStates(this);">
                                    ...
                                    <div class="uk-grid">
                                        <div class="uk-width-medium-1-3">
                                            <label for="exampleFormControlFile1">
                                                <b>State*</b></label>
                                            <div class="uk-button uk-form-select custom-uk-select" data-uk-form-select>
                                                <span style="float: left;" id="billing_state_s"></span>
                                                <i class="uk-icon-caret-down custom-uk-selectDropIcon"></i>
                                                <select name="billing_state" id="billing_state" onChange="getBillingCities(this);">
                                                    <option>Select</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="uk-width-medium-1-3">
                                             <label for="exampleFormControlFile1">
                                                <b>City*</b></label>
                                            <div class="uk-button uk-form-select custom-uk-select" data-uk-form-select>
                                                <span style="float: left;" id="billing_city_s"></span>
                                                <i class="uk-icon-caret-down custom-uk-selectDropIcon"></i>
