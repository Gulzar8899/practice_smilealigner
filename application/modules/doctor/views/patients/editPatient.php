                    ...
                    <div id="account-field">
                        <div class="uk-grid">
                            <div class="uk-width-medium-1-2">
                                <div class="md-input-wrapper"><b>First Name</b><span class="req">*</span><input type="text" name="pt_firstname" id="wizard_fullname" required="" class="md-input demoInputBox input-border" placeholder="Enter First Name" value="<?= $singlePatient[$i]['pt_firstname']; ?>"><span class="md-input-bar"></span></div>
                                
                            </div>
                            <div class="uk-width-medium-1-2">
                                <div class="md-input-wrapper"><b>Last Name</b><span class="req">*</span><input type="text" name="pt_lastname" id="wizard_fullname" required="" class="md-input demoInputBox input-border" placeholder="Enter Last Name" value="<?= $singlePatient[$i]['pt_lastname']; ?>"><span class="md-input-bar"></span></div>
