...
<!--                             <span class="uk-flex">
                                ...
                                <p style="margin: 9px 0px 0px 0px;"><b><?= $treatmentPlans->created_at; ?></b></p>
                            </span> -->
                            ...
                            <span class="uk-flex uk-flex-between" style="align-items:center; margin-top: 15px;">
                                ...
                                <!-- <?php if($treatmentPlans->pre_status == 0 && $treatmentPlans->status == 1): ?>
                                  <a class="md-btn view-treatmentPlan-case" href="<?php echo base_url('doctor/viewModifyTreatmentPlanDetails/').$treatmentPlans->id; ?>"><img src="<?php echo base_url('assets/images/eye-icon.svg'); ?>">&nbsp;&nbsp;View Plan Details</a>
                                <?php endif; ?>

                                <?php if($treatmentPlans->pre_status == 1 && $treatmentPlans->status == 1): ?>
                                    <a class="md-btn view-treatmentPlan-case" href="<?php echo base_url('doctor/viewTreatmentPlanDetails/').$treatmentPlans->id; ?>"><img src="<?php echo base_url('assets/images/eye-icon.svg'); ?>">&nbsp;&nbsp;View Plan Details</a>
                                <?php endif; ?>
