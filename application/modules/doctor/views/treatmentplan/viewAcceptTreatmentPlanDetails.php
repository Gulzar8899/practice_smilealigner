            ...
            <br>
              <div class="uk-grid">
                ...
                <div class="uk-width-medium-1-5 uk-flex uk-flex-right uk-flex-middle">
                     ...
                     <!--   <span class="req-reject-status" style="padding: 5% 10% 3.7%;"><img src="http://localhost/smilealigners/assets/images/red-ellipse.svg">&nbsp;&nbsp;&nbsp;Rejected</span> -->
                </div>
                    ...
                    <div class="uk-grid uk-flex-middle" data-uk-grid-margin>
                        ...
                        <div class="uk-width-medium-1-4 uk-margin-medium-top uk-margin-medium-bottom">
                            <div class="uk-margin-small-left">
                                <a class="uk-margin-small-top md-btn deleteBorder userDataBackground themeTextColor btnSettings md-btn-success md-btn-wave-light waves-effect waves-button waves-light btnDelete" href="#">Reject</a>
                                &nbsp; &nbsp; &nbsp;&nbsp;
                                <a class="uk-margin-small-top md-btn buttonStyling accept-btn" href="">&nbsp;Accept&nbsp;</a>
                            </div>
                        </div>
                    </div>
